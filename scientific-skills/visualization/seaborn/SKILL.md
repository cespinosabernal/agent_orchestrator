...
- Statistical plots with minimal code: distributions, correlations, categorical comparisons
- Built-in error bars, confidence intervals, and aggregation without manual calculation
- Plotting directly from pandas DataFrames using column names
- Quick exploratory visualization of tabular data
- **Prefer matplotlib** when you need fine-grained control over every plot element
- **Prefer plotly** when you need interactive/zoomable output or web embedding
- **Prefer scientific-visualization** when preparing figures for journal submission
