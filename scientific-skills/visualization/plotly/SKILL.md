...
- Interactive exploration: hover tooltips, zoom, pan, and click events
- Web dashboards and self-contained HTML charts for sharing with collaborators
- Presentations requiring dynamic or animated figures
- Rapid visual inspection of large or multidimensional datasets
- **Prefer matplotlib or seaborn** for static publication figures
- **Prefer scientific-visualization** for journal-ready multi-panel figures with strict formatting
