...
description: "Autonomous end-to-end document production pipeline: finds and verifies citations via research-lookup, compiles LaTeX, reviews PDF output, and manages project folder structure for papers, literature reviews, grant proposals, and reports."
license: MIT license
metadata:
...
**Every document should be richly illustrated. Activate the `scientific-schematics` skill for diagrams, flowcharts, and schematics.**
...
| Document Type | Minimum Figures | Recommended |
|--------------|-----------------|-------------|
| Research papers | 5 | 6-8 |
| Literature reviews | 4 | 5-7 |
| Presentations | 1 per slide | 1-2 per slide |
| Posters | 6 | 8-10 |
| Grants | 4 | 5-7 |
...
- [ ] **Figures generated** via `scientific-schematics` skill
...
- **Generate figures** using the `scientific-schematics` skill for schematics, flowcharts, and diagrams
